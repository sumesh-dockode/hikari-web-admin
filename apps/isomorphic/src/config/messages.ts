export const messages = {
  ...
  variantNameIsRequired: 'Variant name is required',
  variantValueIsRequired: 'Variant value is required',
  variantatleastOneIsRequired: 'Add at least one variant',
  variantpriceIsRequired: 'Price is required',
  variantSkuIsRequired: 'Sku is required',
  variantStockIsRequired: 'Stock is required',
