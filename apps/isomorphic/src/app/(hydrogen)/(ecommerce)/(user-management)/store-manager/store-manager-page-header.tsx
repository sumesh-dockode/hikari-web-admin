...
function CreateStoreManagerModalView() {
  ...
  return (
    <div className="m-auto px-5 pb-8 pt-5 @lg:pt-6 @2xl:px-7">
      ...
      <CreateStoreManager isModalView={false} />
    </div>
  );
}
...
export default function StoreManagerPageHeader({
  title,
  breadcrumb,
  className,
}: PageHeaderTypes) {
    ...
    <>
      <PageHeader title={title} breadcrumb={breadcrumb} className={className}>
        <Button
          ...
          onClick={() =>
            openModal({
              view: <CreateStoreManagerModalView />,
              customSize: 720,
            })
          }
        >
