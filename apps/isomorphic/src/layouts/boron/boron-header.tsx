...
export default function BoronHeader() {
  ...
  return (
    <StickyHeader className="fixed start-0 top-0 z-[990] w-full bg-secondary1 dark:backdrop-blur-3xl 2xl:py-5 3xl:px-8 4xl:px-10">
      <div className="flex w-full max-w-2xl items-center">
        ...
        <div className="hidden w-[270px] xl:inline-block 2xl:w-72">
          ...
          >
            <Logo className="max-w-[155px] text-white bg-white" />
          </Link>
        </div>
